...
export class FacturasService {
  ...
  frasURL = 'https://comprasapp-5cebc.firebaseio.com/facturas.json';
  fraURL = 'https://comprasapp-5cebc.firebaseio.com/facturas';
  ...
  getFacturasSearch (busqueda: string) {
    const url = `${ this.frasURL }?orderBy="codigo"&startAt="${ busqueda }"&endAt="${ busqueda }\uf8ff"`;
    return this.http.get(url)
      .pipe( map ( res => res.json() ));
  }
}
